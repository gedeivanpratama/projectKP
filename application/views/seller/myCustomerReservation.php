				...
				<table class="table table-condensed">
					<tbody>
						...
						<tr>
							...
							<th>
                                <a class="btn btn-primary" href="<?= base_url() ?>requestDetail/<?= $value['id_reservasi'] ?>">Detail</a>
                                <a class="btn btn-danger" href="<?= base_url() ?>deleteRequest/<?= $value['id_reservasi'] ?>/<?= $value['id_kamar'] ?>">Delete</a>
                            </th>
