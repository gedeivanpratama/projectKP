<div class="content-wrapper">
    ...
    <div class="box box-primary my-form-ad">
        <div class="box-header with-border">
            <h3 class="box-title">Add Hotel Payment</h3>
        </div>
        ...
        <?php echo form_open_multipart(); ?>
          <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="payment_owner" placeholder="Owner Name :">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_rek" placeholder="Rekening Number :">
                </div>
                <div class="form-group">
                    <label>Hotel :</label>
