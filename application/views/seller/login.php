...
<div class="login-box">
  ...
  <div class="login-box-body">
    <h3 class="text-center">Login As Seller</h3>
    <?php echo form_open(); ?>
      <div class="form-group has-feedback">
        <span class="text-danger"><?php echo form_error('email_seller'); ?></span>
        <input type="text" class="form-control" placeholder="Email" name="email_seller">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <span class="text-danger"><?php echo form_error('seller_password'); ?></span>
        <input type="password" class="form-control" placeholder="Password" name="seller_password">
    ...
    <!-- /.social-auth-links -->
    <br>
    <a href="registerSeller" class="text-center">Register a new membership</a>
