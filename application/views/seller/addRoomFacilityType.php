<div class="content-wrapper">
    ...
    <div class="box box-primary my-form-ad">
        <div class="box-header with-border">
            <h3 class="box-title">Add Hotel Facility</h3>
        </div>

        <?php echo form_open_multipart(); ?>
          <div class="box-body">
                <div class="form-group">
                    <label for="inputAddress">Nama Type Fasilitas  :</label>
                    <span style="color:red;"><?= form_error('nama_fasilitas'); ?></span>
                    <input type="text" class="form-control" name="nama_fasilitas" placeholder="Name Fasilitas:">
                </div>
                <div class="form-group">
                    <label for="inputAddress">Jumlah Fasilitas Hotel :</label>
                    <span style="color:red;"><?= form_error('jumlah_fasilitas'); ?></span>
                    <input type="text" class="form-control" name="jumlah_fasilitas" placeholder="Jumlah Fasilitas:">
                </div>
                <div class="form-group">
                    <label>Hotel :</label>
                    ...
                    <select name ="id_type" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                        ...
                        <option value="<?= $val['id_type'] ?>"><?= $val['nama_type'] ?></option>
                        <?php endforeach;?>
                    </select>
                </div>
          </div>
